...
abstract class Expr {
    ...
    static class FunctionExpression extends Expr {
        List<Token> parameters;
        List<Stmt> body;

        FunctionExpression(List<Token> params, List<Stmt> body) {
    ...
    static class GetExpression extends Expr {
        ...
        GetExpression(Token name, Expr object) {
            this.name = name;
            this.object = object;
    ...
    static class ThisExpression extends Expr {
        final Token keyword;

        ThisExpression(Token keyw) {
            this.keyword = keyw;
        }
